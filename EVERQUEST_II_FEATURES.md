# EverQuest II Edition - Features Guide
...
- **Human** - Balanced (+1 to all stats)
- **Barbarian** - Fierce warriors (+3 Durability, +1 Skill)
- **High Elf** - Arcane masters (+3 Mysticism, +1 Presence)
- **Half Elf** - Versatile (+2 Mysticism, +1 Skill)
- **Dwarf** - Resilient defenders (+2 Durability, +1 Presence)
- **Gnome** - Clever tinkerers (+2 Mysticism, +2 Skill)
- **Halfling** - Lucky rogues (+3 Skill)
- **Erudite** - Brilliant scholars (+4 Mysticism, +1 Presence)
- **Kerra** - Feline hunters (+1 Durability, +2 Skill)
- **Fae** - Magical faeries (+3 Mysticism, +2 Presence)
- **Froglok** - Honorable warriors (+2 Durability, +1 Skill)

#### **Evil Aligned Races (Freeport)**
- **Dark Elf** - Shadow masters (+2 Mysticism, +1 Skill)
- **Iksar** - Scaled warriors (+3 Durability)
- **Troll** - Regenerating brutes (+4 Durability)
- **Ogre** - Devastating giants (+4 Durability)
...
Begin your journey as one of four archetypes:

1. **Fighter** - Masters of melee combat and heavy armor
   - High Durability and Stamina
   - Starting HP: 22
   - Excels at tanking and physical damage

2. **Priest** - Divine healers and support specialists
   - High Mysticism and Presence
   - Large Mana pool (80)
   - Healing and buffing abilities

3. **Mage** - Arcane spellcasters wielding elemental magic
   - Exceptional Mysticism
   - Largest Mana pool (100)
   - Devastating spell damage

4. **Scout** - Agile combatants using stealth and precision
   - High Skill
...
Choose a deity to worship and gain powerful blessings:

### **Good Deities**
- **Mithaniel Marr** - Lightbringer (+2 Dur, +1 Skill, +2 Presence)
- **Tunare** - Mother of All (+2 Myst, +1 Skill, +2 Presence)
- **Quellious** - The Tranquil (+1 Dur, +2 Myst, +2 Presence)
- **Rodcet Nife** - Prime Healer (+3 Myst, +2 Presence)
- **Erollisi Marr** - Queen of Love (+1 Myst, +1 Skill, +3 Presence)

### **Neutral Deities**
- **Bristlebane** - King of Thieves (+4 Skill, +1 Presence)
- **Solusek Ro** - Burning Prince (+4 Mysticism)
- **Karana** - Rainkeeper (+1 to all stats)

### **Evil Deities**
- **Innoruuk** - Prince of Hate (+2 Dur, +2 Myst, +1 Skill)
- **Cazic-Thule** - The Faceless (+1 to all stats)
- **Bertoxxulous** - Plaguebringer (+3 Myst, +1 Presence)
- **Rallos Zek** - The Warlord (+3 Dur, +2 Skill)
...
- **Spiritual Renewal** - Healing over time (40 mana)
...
Explore iconic EverQuest II locations:

- **Depths 1-4: Antonica** - Farmlands surrounding Qeynos
- **Depth 5: Gnollish Stronghold** - Sabertooth clan hideout
- **Depths 6-9: Blackburrow** - Ancient gnoll warren
- **Depth 10: Sabertooth Throne Room** - Gnoll chieftain's lair
- **Depths 11-14: Crushbone Citadel** - Orcish fortress
- **Depth 15: Emperor's Fortress** - Emperor Crush's domain
- **Depths 16-19: Lavastorm Mountains** - Volcanic dragon realm
- **Depth 20: Nagafen's Lair** - Lord Nagafen's domain
- **Depths 21-24: Plane of Fear** - Cazic-Thule's nightmare realm
...
### **Regular Enemies**
- Kobolds (Stormhold reptilians)
- Sabertooth Gnolls (Blackburrow raiders)
- Crushbone Orcs (Emperor's forces)
- Undead Knights (cursed warriors)
- Lavastorm Drakes (fire-breathing dragons)
- Runnyeye Goblins (cunning trappers)
- Storm Giants (massive titans)
- Ancient Treants (forest guardians)

### **Named/Boss Enemies**
- **Gnasher the Fierce** - Legendary gnoll champion
- **Lord Darish the Fallen** - Corrupted undead paladin
...
- **Earthcaller** - Shaman staff that roots enemies
...
- **Dragonscale Armor** - Tier 7 dragon scale armor

### **Rings**
- **Ring of Nagafen's Flame** - Fire resistance
- **Ring of the Serpent** - Poison immunity

---

## 🧪 Consumables

- **Halfling's Bread** - Nourishing food (+10 HP)
- **Potion of Cazic's Blessing** - Temporary stat boost
- **Potion of Dragonfire** - Enhanced liquid flame
- **Scroll of Recall** - Teleportation scroll (disabled in dungeons)

### **Quest Items**
- **Sabertooth Gnoll Fang** - Trophy from gnolls
- **Crushbone Orc Belt** - Proof of orc kills
- **Red Dragon Scale** - Rare crafting material (500 gold!)

---

## ✨ Buffs & Debuffs

- **Divine Blessing** - Deity-granted power boost
- **Stone Skin** - Massive defense increase (Guardian)
- **Shadow Form** - Increased evasion and crits (Assassin)
- **Arcane Focus** - Spell damage increase (Wizard)
- **Nature's Ward** - Regeneration + poison immunity (Druid)

---

## 📊 Stat System - The Four Pillars

### **D.A.D. (Durability)**
- Physical resilience, health, defense
- Important for: Fighters, tanks

### **M.A.D. (Mysticism)**
- Magical power, mana, spell effectiveness
- Important for: Mages, Priests

### **S.A.D. (Skill)**
- Accuracy, evasion, critical strikes, stealth
- Important for: Scouts, rogues

### **P.A.D. (Presence)**
- Charisma, awareness, companion abilities, healing power
- Important for: Priests, bards
...
### **Ultimate Wizard**
- Race: High Elf or Erudite
- Class: Mage → Wizard
- Deity: Solusek Ro
- **Total Mysticism: +7 to +8**

### **Perfect Assassin**
- Race: Halfling or Ratonga
...
- Deity: Rallos Zek or Mithaniel Marr
- **Total Durability: +7**

### **Master Healer**
- Race: Erudite or High Elf
- Class: Priest → Cleric
- Deity: Rodcet Nife
- **Total Mysticism: +7**
...
Each combination offers a unique playstyle and stat distribution!
...
Every aspect integrates authentic EverQuest II lore:
- Zone descriptions reference actual EQ2 locations
- Monsters have accurate lore and behavior
- Items include detailed backstories
- Deities match EQ2 pantheon
- Classes follow EQ2 progression paths

---

**Welcome to Norrath, adventurer! May the gods watch over you in your journey through these perilous dungeons!**

*For the glory of Qeynos! For the power of Freeport!*
